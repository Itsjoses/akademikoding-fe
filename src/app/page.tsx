  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex flex-col items-center text-center px-6 pt-24 pb-20">
        <div className="inline-flex items-center gap-2 rounded-full bg-violet-50 dark:bg-violet-950 border border-violet-100 dark:border-violet-900 px-4 py-1.5 text-xs font-medium text-violet-600 dark:text-violet-400 mb-6">
          <Zap size={12} />
          Platform belajar coding #1 Indonesia
        </div>
        <h1 className="max-w-2xl text-4xl sm:text-5xl font-bold text-neutral-900 dark:text-zinc-50 leading-tight tracking-tight">
          Belajar coding lebih cepat,{" "}
          <span className="text-violet-600 dark:text-violet-400">
            lebih terarah.
          </span>
        </h1>
        <p className="mt-5 max-w-lg text-base text-description leading-relaxed">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="#fitur"
            className="rounded-lg border border-neutral-200 dark:border-zinc-700 px-6 py-3 text-sm font-medium text-neutral-600 dark:text-zinc-300 hover:bg-neutral-50 dark:hover:bg-zinc-800 transition"
          >
            Lihat Fitur
          </Link>
        </div>
      ...
      {/* Stats */}
      <section className="border-y border-neutral-100 dark:border-zinc-800 py-10">
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-2 sm:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={stat.label}>
              <div className="text-2xl font-bold text-neutral-900 dark:text-zinc-50">
                {stat.value}
              </div>
              <div className="text-sm text-neutral-500 dark:text-zinc-400 mt-1">
                {stat.label}
              </div>
            </div>
          ))}
      ...
      <section id="fitur" className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-neutral-900 dark:text-zinc-50">
              Semua yang kamu butuhkan
            </h2>
            <p className="mt-3 text-neutral-500 dark:text-zinc-400 text-sm max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f) => (
              <div
                key={f.title}
                className="rounded-xl border border-neutral-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 hover:border-violet-100 dark:hover:border-violet-900 hover:bg-violet-50/30 dark:hover:bg-violet-950/20 transition"
              >
                <div className="w-9 h-9 rounded-lg bg-violet-100 dark:bg-violet-950 flex items-center justify-center text-violet-600 dark:text-violet-400 mb-4">
                  <f.icon size={18} />
                </div>
                <h3 className="font-semibold text-neutral-900 dark:text-zinc-100 text-sm mb-1.5">
                  {f.title}
                </h3>
      ...
      <section
        id="pricing"
        className="py-20 px-6 bg-neutral-50 dark:bg-zinc-950"
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
            {/* Annual */}
            <div className="rounded-2xl border border-neutral-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8">
              ...
              <div className="mt-4 flex items-end gap-1">
                <span className="text-4xl font-bold text-neutral-900 dark:text-zinc-50">
                  Rp 299K
                </span>
                <span className="text-neutral-400 dark:text-zinc-500 text-sm mb-1">
                  /tahun
                </span>
              </div>
              ...
              <ul className="mt-6 flex flex-col gap-3">
                {annualIncludes.map((item) => (
                  <li
                    key={item}
                    className="flex items-start gap-2.5 text-sm text-neutral-600 dark:text-zinc-300"
                  >
                    <CheckCircle2
                      size={16}
              ...
              <Link
                href="/register"
                className="mt-8 block w-full text-center rounded-lg border border-neutral-200 dark:border-zinc-700 px-4 py-2.5 text-sm font-medium text-neutral-700 dark:text-zinc-300 hover:bg-neutral-50 dark:hover:bg-zinc-800 transition"
              >
                Pilih Tahunan
              </Link>
            </div>
            ...
            {/* Lifetime */}
            <div className="rounded-2xl bg-violet-600 dark:bg-violet-700 p-8 relative">
          ...
          <p className="text-center text-xs text-neutral-400 dark:text-zinc-500 mt-6">
      ...
      <section className="py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mt-3 text-neutral-500 dark:text-zinc-400 text-sm">
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-100 dark:border-zinc-800 py-8 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="font-mono text-sm font-bold text-neutral-900 dark:text-zinc-50">
            Akademi
